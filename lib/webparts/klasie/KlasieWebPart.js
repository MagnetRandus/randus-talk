...
import * as strings from "KlasieWebPartStrings";
import Klasie from "./components/Klasie";
var KlasieWebPart = /** @class */ (function (_super) {
    ...
    KlasieWebPart.prototype.render = function () {
        var element = React.createElement(Klasie, {
                    ...
                    groups: [
                        {
                            ...
                            groupFields: [
                                ...
                                PropertyPaneDropdown("GPTModel", {
                                    label: strings.GPTModel,
                                    options: [
                                        {
                                            key: "gpt-3.5-turbo",
                                            text: "gpt-3.5-turbo",
...
export default KlasieWebPart;
//# sourceMappingURL=KlasieWebPart.js.map